...
public class JMSEventPublisher implements IJMSEventPublisher {
    ...
    public void publish(EventId eventId, EventData data){
        try(JMSContext jmsContext = connectionFactory.createContext()) {
            ...
            txt.setStringProperty(PropertiesConsumer.ORIGIN_QUEUE, JMSQueueNames.HOTEL_ORCHESTRATOR_QUEUE);
            LOGGER.info("Publicando en Cola {}, Evento Id: {}, Mensaje: {}", JMSQueueNames.HOTEL_ORCHESTRATOR_QUEUE, eventId, msg);
